...
# usar o time para o comando aguardar 5 segundos antes de executar para dar tempo de posicionar o mouse onde desejo clicar (campo login)
time.sleep(5)
print(pyautogui.position())
# copiar a posição e colar no seu código principal

#         codigo       marca        tipo  categoria  91.2       
#   699.0   167.8     custo               obs
